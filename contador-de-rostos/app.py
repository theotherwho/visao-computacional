...
def main():
    ...
    total_pixels = w * h  # Calcula o número de pixels na área de interesse
    ...
    while True:
        ...
        # Aplica limiarização e dilatação para melhorar a detecção
        _, imgTh = cv2.threshold(fgMask, 200, 255, cv2.THRESH_BINARY)
      ...
      #  cv2.putText(img, f'Brancos: {brancos}', (x - 30, y - 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 1)
      #  cv2.putText(img, f'Pixels: {total_pixels}', (x - 30, y - 20), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 1)
